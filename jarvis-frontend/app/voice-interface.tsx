            ...
            <div className="text-center space-y-3 min-h-[80px]">
                ...
                {imageUrl && state !== "processing" && (
                    <div className="mt-4 animate-fade-in relative group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-jarvis-cyan to-blue-600 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
                        <img 
                            src={imageUrl} 
                            alt="Generated by JARVIS" 
                            className="relative rounded-lg border border-jarvis-cyan/30 shadow-2xl max-w-[300px] h-auto object-cover transform transition-all duration-500 hover:scale-105"
                        />
                    </div>
                )}
